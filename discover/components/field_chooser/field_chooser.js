    ...
    return {
      ...
      link: function ($scope) {
        $scope.setIndexPattern = function (id) {
		  ...
		  console.log("$scope.state.query = "+$scope.state.query.query_string.query);
		  console.log("$scope.state.query1 ="+$scope.state.query1);
		  console.log("$scope.state.query2 ="+$scope.state.query2);
		  //当切换索引时，重置query ='*' query1=null  query2=null
		  $scope.state.query.query_string.query = '*';
		  $scope.state.query1 = null;
		  $scope.state.query2 = null;
		  console.log("AAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
          $scope.state.save();
        };
